...
// console.log("2562",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[4].card.card.title)
// console.log("840",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[1].card.card.itemCards[5].card.info.ratings.aggregatedRating)
// console.log("650",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[1].card.card.itemCards[2].card.info.ratings.aggregatedRating.ratingCountV2)
// console.log("3544",swiggyResponse.data.firstOffsetRequest)
// console.log("10",swiggyResponse.data.cards[0].card.card.text)
// console.log("899",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[1].card.card.itemCards[6].card.info.ribbon.bottomBackgroundColor)
// console.log("1567",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[1].card.card.itemCards[18].card)
// console.log("587",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[1].card.card.itemCards[2].card.info)
// console.log("2222",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[3].card.card.itemCards[1].card.info.itemAttribute)
// console.log("3333",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[7].card.card.itemCards[0].card.info.badgesV2)
// console.log("999",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[1].card.card.itemCards[8].card.info.variants.variantGroups[0])
// console.log("1111",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[1].card.card.itemCards[10].card)
// console.log("2500",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[3].card.card.itemCards[6].card.info.category)
// console.log("89",swiggyResponse.data.cards[2].card.card.info.availability.nextCloseTime)
// console.log("786",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[1].card.card.itemCards[4].card.hideRestaurantDetails)
// console.log("1854",swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[2].card.card.itemCards[2].card.info.variants.variantGroups[0].name)

const {}    


  document.write(`Hi My name is Chahat.
 I went to a ${} Restro and i ordered ${}.
